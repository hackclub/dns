...
2. In your fork open the [hackclub.com.yaml](./hackclub.com.yaml) file and add the following to the bottom of the file:
...
4. Replace `SOURCE_DOMAIN_OR_IP` with the domain or IP address of the website you want the subdomain to go. Remember to leave that `.` at the end!
